...
void IntegratorBase::SetInternalForces(double * internalForces)
{
  memcpy(this->internalForces,internalForces,sizeof(double)*r);
}

void IntegratorBase::GetInternalForces(double * internalForces_copy)
{  memcpy(internalForces_copy,internalForces,sizeof(double)*r);}
