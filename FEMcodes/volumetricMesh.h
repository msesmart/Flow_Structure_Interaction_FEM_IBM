...
public:
  ...
  // save the mesh to a obj file (tecplot version Finite Element format)
  virtual int saveToFE_obj(const char *filename) const=0;
  virtual int saveDeformationToFE_obj(const char * filename, double *u_, double *f_int_) const=0;
...
protected:
  ...
  int saveToFE_obj(const char * filename, elementType elementType_) const;
  int saveDeformationToFE_obj(const char * filename, double *u_, double *f_int_, elementType elementType_) const;
