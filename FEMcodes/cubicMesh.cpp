...
int CubicMesh::saveToFE_obj(const char * filename) const
{
  return VolumetricMesh::saveToFE_obj(filename, elementType_);
}

int CubicMesh::saveDeformationToFE_obj(const char * filename, double *u_, double *f_int_) const
{
  return VolumetricMesh::saveDeformationToFE_obj(filename, u_, f_int_, elementType_);
}
